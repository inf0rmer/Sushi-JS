 ...
 define('sushi.ui.typeahead',
 	...
 	function(Sushi, utils, collection, JSON, browser, $) {
		...
		* ================================= */
		...
		Typeahead.prototype = {
			...
			, show: function () {			
				...
				this.$menu.show().css({display: 'block'});
				this.shown = true
				return this
			}
			...
			, lookup: function (event) {
				...
				items = collection.filter(this.source, function (item) {
			...
			, render: function (items) {
				...
				items = collection.map(items, function (item, i) {
				...
				this.$menu.html('')
				collection.each(items, function(item) {
		...
		* =========================== */
		...
		Sushi.fn.typeahead.Constructor = Typeahead

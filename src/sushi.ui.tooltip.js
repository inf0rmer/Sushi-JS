		  ...
		  * =============================== */
		  ...
		  , init: function (type, element, options) {
			  ...
			  if (this.options.trigger != 'manual') {
				...
				this.$element.on(eventIn, utils.bind(this.enter, this), $)
				this.$element.on(eventOut, utils.bind(this.leave, this), $)
			  }
		  ...
		  , enter: function (e) {
			  var self = $(e.target)[this.type](this._options).data(this.type)
